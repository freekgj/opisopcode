...
def transfer(catogory1, catogory2, catogory3, catogory4, catogory5, catogory6, catogory7):
    ...
    #mycursor.execute("CREATE TABLE products (_id INT(15), brand VARCHAR(20), category VARCHAR(80), fast_mover BOOLEAN, gender varchar(10), herhaalaankopen BOOLEAN, selling_price INT(15))")
    ...
    product = (int(catogory1), str(catogory2), str(catogory3), bool(catogory4), str(catogory5), bool(catogory6), int(catogory7))
